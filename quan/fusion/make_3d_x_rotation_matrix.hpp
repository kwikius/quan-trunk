#ifndef QUAN_FUSION_MAKE_3D_X_ROTATION_MATRIX_HPP_INCLUDED
#define QUAN_FUSION_MAKE_3D_X_ROTATION_MATRIX_HPP_INCLUDED
...
namespace quan{ namespace fusion{
   ...
   template <typename Q>
   inline
   typename quan::fusion::detail::make_3d_x_rotation_matrix_impl::apply<Q>::type
   make_3d_x_rotation_matrix(quan::angle::rad const & theta)
   {
      return quan::fusion::detail::make_3d_x_rotation_matrix_impl{} (Q{}, theta);
   }

}}// quan::fusion


#endif // QUAN_FUSION_MAKE_3D_X_ROTATION_MATRIX_HPP_INCLUDED
