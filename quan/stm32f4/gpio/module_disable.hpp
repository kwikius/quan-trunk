#ifndef QUAN_STM32F4_GPIO_MODULE_DISABLE_HPP_INCLUDED
#define QUAN_STM32F4_GPIO_MODULE_DISABLE_HPP_INCLUDED
/*
...
namespace quan{ namespace stm32f4{
    ...
    module_disable()
    {
        ...
        quan::stm32f4::rcc::get()->ahb1enr. template clearbit<bit_offset>();
    }

}}// quan::stm32f4

#endif // QUAN_STM32F4_GPIO_MODULE_DISABLE_HPP_INCLUDED
