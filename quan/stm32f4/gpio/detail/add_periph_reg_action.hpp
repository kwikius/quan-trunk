#ifndef QUAN_STM32F4_GPIO_DETAIL_ADD_PERIPH_REG_ACTION_HPP_INCLUDED
#define QUAN_STM32F4_GPIO_DETAIL_ADD_PERIPH_REG_ACTION_HPP_INCLUDED
/*
...
#include <quan/stm32f4/gpio/mode.hpp>
...
*/
  ...
  struct add_periph_reg_action<Listof_PeriphRegAction, PeriphRegOrAction, PeriphRegAndAction, GpioModule, PeriphRegSetting,
      typename quan::where_<
         quan::meta::and_<
            quan::is_model_of<quan::stm32f4::Gpio,GpioModule>,
            quan::is_model_of<quan::stm32f4::gpio::AlternateFunction,PeriphRegSetting> 
         >
      >::type
  >{
       typedef quan::stm32f4::detail::periph_reg_action_pack<
         GpioModule,quan::stm32f4::gpio::mode::alternate_function
       > alt_fn_actions;
...
#endif // QUAN_STM32F4_GPIO_DETAIL_ADD_PERIPH_REG_ACTION_HPP_INCLUDED
