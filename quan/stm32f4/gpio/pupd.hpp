#ifndef QUAN_STM32F4_GPIO_PUPD_HPP_INCLUDED
#define QUAN_STM32F4_GPIO_PUPD_HPP_INCLUDED
...
namespace quan{ namespace impl{
   ...
   struct is_model_of_impl<
			quan::stm32f4::gpio::Pupd,
			quan::stm32f4::gpio::pupd_value<V> 
	> : quan::meta::true_{};
...
#endif // QUAN_STM32F4_GPIO_PUPD_HPP_INCLUDED
