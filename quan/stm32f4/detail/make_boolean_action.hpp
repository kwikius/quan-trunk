...
namespace quan{ namespace stm32f4{ namespace detail {
   ...
   */
   ...
   struct make_or_action{
      ...
      typedef quan::stm32f4::detail::periph_reg_action<PeriphReg,quan::meta::bit_or,quan::bit<value_type>(BitPos) > type;
   };
   ...
   struct make_and_action{
      typedef PeriphReg reg_type;
      typedef typename reg_type::value_type value_type;
      typedef quan::stm32f4::detail::periph_reg_action<PeriphReg,quan::meta::bit_and,~quan::bit<value_type>(BitPos) > type;
   };
