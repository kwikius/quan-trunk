#ifndef QUAN_STM32F4_DETAIL_PERIPH_REG_ACTIONS_HPP_INCLUDED
#define QUAN_STM32F4_DETAIL_PERIPH_REG_ACTIONS_HPP_INCLUDED
/*
...
//----------------------------------------------------------------------------
   ...
   // PeripReg is a model of quan::stm32f4:;PeriphReg
   ...
   struct periph_reg_action{
      ...
      void operator()() const
      {
          ...
          typedef quan::stm32f4::detail::get_reg<module_type, periph_reg_type> get_reg;
          auto ptr = get_reg{}();
          function()(*ptr, value);
      }
   };
...
//---------
    ...
    struct fold_periph_reg_actions{
      ...
      typedef typename quan::meta::eval_if_c<
       (quan::meta::get_num_elements<Listof_PeriphRegAction>::value > 0),
        quan::stm32f4::detail::fold_periph_reg_actions_impl<Listof_PeriphRegAction>,
        quan::stm32f4::detail::periph_reg_null_action
     >::type  type;
   ...
   struct make_combined_periph_reg_action{
       ...
       typedef quan::stm32f4::detail::periph_reg_combined_action<
         typename OrAction::periph_reg_type, OrAction::value, AndAction::value
       > type; 
   };

   template <> 
   struct make_combined_periph_reg_action<quan::stm32f4::detail::periph_reg_null_action, quan::stm32f4::detail::periph_reg_null_action>
   {    
        typedef quan::stm32f4::detail::periph_reg_null_action type;
   };

   template <typename AndAction> 
   struct make_combined_periph_reg_action<quan::stm32f4::detail::periph_reg_null_action, AndAction>
   {
        typedef AndAction type;
   };

   template <typename OrAction> 
   struct make_combined_periph_reg_action< OrAction, quan::stm32f4::detail::periph_reg_null_action>
   {
...
//########################################################################################################
      typedef typename quan::stm32f4::detail::get_periph_reg_actions_for_this_module<Module,Listof_PeriphRegAction>::type module_actions;
...
//####################################################################################
      ...
      struct reduce_and_or_actions_to_single_action{
         ...
         typedef typename quan::stm32f4::detail::get_or_periph_reg_actions<RegActions>::type or_reg_actions;
         // fold all or_actions into one
         typedef typename quan::stm32f4::detail::fold_periph_reg_actions<or_reg_actions>::type  or_action;

         typedef typename quan::stm32f4::detail::get_and_periph_reg_actions<RegActions>::type and_reg_actions;
         // fold all and_actions into one
         typedef typename quan::stm32f4::detail::fold_periph_reg_actions<and_reg_actions>::type and_action;

         typedef typename quan::stm32f4::detail::periph_reg_reduce_action<or_action>::type or_action1;
         typedef typename quan::stm32f4::detail::periph_reg_reduce_action<and_action>::type and_action1;
      ...
      struct reduce_to_single_action{
         ...
         typedef typename quan::stm32f4::detail::get_assign_periph_reg_actions<RegActions>::type assign_reg_actions;
      ...
      void operator()() const
      {
         typedef typename quan::stm32f4::detail::get_actions_that_apply_to_this_periph_reg<PeriphReg,Listof_PeriphRegAction>::type list_of_reg_actions;
...
namespace quan{ namespace impl{
   ...
   struct is_model_of_impl<
      ...
      quan::stm32f4::detail::apply_periph_reg_actions<Module,Listof_PeriphRegAction>
   > : quan::meta::true_{};
...
// convert periph_reg_action_pack to polymorphic_functor
   ...
   struct make_periph_reg_action_pack{
     ...
     struct apply{
        typedef  quan::stm32f4::detail::periph_reg_action_pack<Pin,PeriphRegSetting> type;
     };
   };

}}}//quan:stm32f4::detail

#endif // QUAN_STM32F4_DETAIL_PERIPH_REG_ACTIONS_HPP_INCLUDED
