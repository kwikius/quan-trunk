#ifndef QUAN_STM32F4_UNDEFINED_REG_HPP_INCLUDED
#define QUAN_STM32F4_UNDEFINED_REG_HPP_INCLUDED
/*
...
namespace quan{ namespace impl{
      ...
      struct is_model_of_impl<
         quan::stm32f4::UndefinedPeriphReg,
         quan::stm32f4::undefined_reg<Module,Offset> 
      > : quan::meta::true_{};
...
namespace quan{ namespace stm32f4 {namespace detail {
       ...
       struct periph_reg_is_defined{
            ...
            template <typename PeriphReg> struct apply{
                  typedef quan::meta::not_<quan::is_model_of<quan::stm32f4::UndefinedPeriphReg,PeriphReg> > type;
            };
       };
   }
...
#endif // QUAN_STM32F4_UNDEFINED_REG_HPP_INCLUDED
