#ifndef QUAN_STM32_F0_GPIO_MODULE_RESET_HPP_INCLUDED
#define QUAN_STM32_F0_GPIO_MODULE_RESET_HPP_INCLUDED
/*
...
namespace quan{ namespace stm32{
    ...
    module_reset()
    {
        ...
        quan::stm32::rcc::get()->ahbrstr. template setbit<bit_offset>();
        quan::stm32::rcc::get()->ahbrstr. template clearbit<bit_offset>();
    }
