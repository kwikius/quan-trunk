#ifndef QUAN_STM32_F0_EXTI_MODULE_HPP_INCLUDED
#define QUAN_STM32_F0_EXTI_MODULE_HPP_INCLUDED
/*
...
namespace quan{ namespace stm32{
   ...
   struct exti{
      ...
      imr_type imr;  // Interrupt mask register
      emr_type emr;  // Event mask register
      rtsr_type rtsr; // Rising trigger selection register
      ftsr_type ftsr;  // Falling trigger selection register
      swier_type swier; // Software interrupt event register
      pr_type pr;       // pending register
