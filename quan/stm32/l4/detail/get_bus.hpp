#ifndef QUAN_STM32_L4_DETAIL_GET_BUS_HPP_INCLUDED
#define QUAN_STM32_L4_DETAIL_GET_BUS_HPP_INCLUDED
/*
...
namespace quan{ namespace stm32{ namespace detail{
   ...
   struct get_bus_c<Address,typename quan::where_c< 
      ((Address <= quan::stm32::periph_map::rng) && (Address >= quan::stm32::periph_map::gpioa)) >::type
   >{
      typedef ahb2 type;
   };
   ...
   template<uint32_t Address>
   struct get_bus_c<Address,typename quan::where_c< 
      ((Address <= quan::stm32::periph_map::tsc) && (Address >= quan::stm32::periph_map::dma1)) >::type
   >{
      typedef ahb1 type;
   };
   ...
   template<uint32_t Address>
   struct get_bus_c<Address,typename quan::where_c< 
      ((Address <= quan::stm32::periph_map::sai1) && (Address >= quan::stm32::periph_map::syscfg)) >::type
   >{
      typedef apb2 type;
   };
   ...
   template<uint32_t Address>
   struct get_bus_c<Address,typename quan::where_c< 
      ((Address <= quan::stm32::periph_map::lptim2) && (Address >= quan::stm32::periph_map::tim2)) >::type
   >{
      typedef apb1 type;
   };
