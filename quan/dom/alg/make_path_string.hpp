...
namespace quan{ namespace dom{
   ...
   template <typename CharType>
    ...
    template <typename CharType>
    inline
    std::basic_string<CharType>  make_path_string(const CharType*  str)
    {
        return std::basic_string<CharType>( str);
    }
    template <typename CharType>
    inline
    std::basic_string<CharType> const & make_path_string(std::basic_string<CharType> const & str)
    {
        return str;
    }
