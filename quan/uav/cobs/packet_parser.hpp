#ifndef QUAN_UAV_COBS_PACKET_PARSER_HPP_INCLUDED
#define QUAN_UAV_COBS_PACKET_PARSER_HPP_INCLUDED
...
namespace quan{ namespace uav{ namespace cobs{
   ...
   struct packet_parser{
      ...
      ~packet_parser()
      {
         ...
         delete [] m_decoded_packet_buffer;
      }
...
#endif // QUAN_UAV_COBS_PACKET_PARSER_HPP_INCLUDED
