...
namespace {
   ...
   */
   ...
   #else
       bool r2
       = conv_impl<quan::pressure_<QUAN_INT32>::kPa>( quan::pressure::mPa(10),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r2);
   ...
   #else
           bool r3 
       = conv_impl<quan::pressure_<QUAN_INT32>::cPa>( quan::pressure::mPa(10),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r3);
