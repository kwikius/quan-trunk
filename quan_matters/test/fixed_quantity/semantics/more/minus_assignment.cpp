...
#define QUAN_TEST_FUN(fun) void fun ();
   ...
   QUAN_TEST_FUN(conv_minus_assign_coh_gt_coh)
   QUAN_TEST_FUN(conv_minus_assign_coh_gt_coh_int)
   QUAN_TEST_FUN(conv_minus_assign_coh_less_coh)
   QUAN_TEST_FUN(conv_minus_assign_coh_less_coh_int)
   QUAN_TEST_FUN(conv_minus_assign_coh_to_gt_inco)
   QUAN_TEST_FUN(conv_minus_assign_coh_to_gt_inco_int)
   QUAN_TEST_FUN(conv_minus_assign_coh_to_less_inco)
   QUAN_TEST_FUN(conv_minus_assign_coh_to_less_inco_int)
   QUAN_TEST_FUN(conv_minus_assign_incoh_gt_inco)
   QUAN_TEST_FUN(conv_minus_assign_incoh_gt_inco_int)
   QUAN_TEST_FUN(conv_minus_assign_incoh_less_inco)
   QUAN_TEST_FUN(conv_minus_assign_incoh_less_inco_int)
...
namespace {
   ...
   std::pair<bool,To> conv_minus_assign_impl(From const & rhs, QUAN_FLOAT_TYPE eps = QUAN_FLOAT_TYPE(0))
   {
   ...
   std::pair<bool,To> conv_minus_assign_impl(From const & rhs)
   {
       typename quan::meta::eval_exponent<Exp>::eval ev;
       return conv_minus_assign_impl<To>(rhs,ev());
   }
   ...
   void conv_minus_assign_coh_gt_coh()
   {
       bool r1 
   ...
   #else
        bool r2
       = conv_minus_assign_impl<quan::pressure::kPa>( quan::pressure::mPa(1.1e9),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r2);
   ...
   #else
        bool r3 
       = conv_minus_assign_impl<quan::pressure::cPa>( quan::pressure::mPa(10234.8976),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r3);

       bool r4 
       = conv_minus_assign_impl<quan::pressure::MPa>( quan::pressure::kPa(9e20),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r4); 

       bool r5
       = conv_minus_assign_impl<quan::pressure::MPa>( quan::pressure::Pa(10),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r5);
   }

   //coherent, floating-pt --> coarser-grained units coherent, int value_type
   void conv_minus_assign_coh_gt_coh_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kPa>( quan::pressure::Pa(10),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
   #ifndef __AVR__
       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::MPa>( quan::pressure::mPa(10),FP_MAX_DIFFERENCE).first;
   #else
       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kPa>( quan::pressure::mPa(10),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r2);
   #ifndef __AVR__
       bool r3 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::cPa>( quan::pressure::fPa(10),FP_MAX_DIFFERENCE).first;
   #else
       bool r3 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::cPa>( quan::pressure::mPa(10),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r3);

       bool r4 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::MPa>( quan::pressure::kPa(10),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r4); 
   }

   // coherent, floating-pt --> finer-grained units coherent, floating-pt
   void conv_minus_assign_coh_less_coh()
   {
       bool r1 
   ...
   #else
       bool r3 
       = conv_minus_assign_impl<quan::pressure::mPa>( quan::pressure::cPa(-34),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r3);

       bool r4 
       = conv_minus_assign_impl<quan::pressure::kPa>( quan::pressure::MPa(6789),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r4); 
   }

   //coherent, floating-pt --> finer-grained units coherent with int value_type
   void conv_minus_assign_coh_less_coh_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::Pa>( quan::pressure::kPa(123),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
   #ifndef __AVR__
       bool r2 = false;
       try{
            conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::Pa>( quan::pressure::MPa(9876),FP_MAX_DIFFERENCE).first;
       }
       catch(std::exception &){
           r2 = true;
       }
       ...
       bool r3 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::mPa>( quan::pressure::cPa(-34),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r3);

       bool r4 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kPa>( quan::pressure::MPa(67),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r4); 
   }

   // coherent, floating-pt --> coarser-grained units incoherent, floating-pt
   void conv_minus_assign_coh_to_gt_inco()
   {
       bool r1 
   ...
   #else
        bool r2
       = conv_minus_assign_impl<quan::pressure::mbar>( quan::pressure::mPa(25e3),FP_MAX_DIFFERENCE).first;
   #endif
       QUAN_CHECK(r2);

       bool r3
       = conv_minus_assign_impl<quan::pressure::dyn_per_cm2>( quan::pressure::mPa(.0008),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r3);
   }

   // coherent, floating-pt --> coarser-grained units incoherent , int value_type
   void conv_minus_assign_coh_to_gt_inco_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::cmHg>( quan::pressure::mPa(1.676),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);

       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::mbar>( quan::pressure::mPa(25.034),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);

       bool r3
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::dyn_per_cm2>( quan::pressure::mPa(.0008),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r3);

       bool r4
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::atm>( quan::pressure::Pa(.08),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r4);
   }

       //coherent, floating-pt --> finer-grained units incoherent, floating-pt
   void conv_minus_assign_coh_to_less_inco()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure::dyn_per_cm2>( quan::pressure::Pa(1.676),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure::kgf_per_m2>( quan::pressure::kPa(201.7867),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);
        
       bool r3
       = conv_minus_assign_impl<quan::pressure::in_water39_2F>( 
           quan::pressure::MPa(1.676),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r3);

        bool r4
       = conv_minus_assign_impl<quan::pressure::atm>( 
   ...
   void conv_minus_assign_coh_to_less_inco_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::dyn_per_cm2>( 
           quan::pressure::Pa(1.676),FP_MAX_DIFFERENCE
       ).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kgf_per_m2>( 
           quan::pressure::kPa(201.7867),FP_MAX_DIFFERENCE
       ).first;
       QUAN_CHECK(r2);
        
       bool r3
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::in_water39_2F>( 
           quan::pressure::MPa(1.676),FP_MAX_DIFFERENCE
       ).first;
       QUAN_CHECK(r3);

        bool r4
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::atm>( 
           quan::pressure::MPa(1.676),FP_MAX_DIFFERENCE
       ).first;
       QUAN_CHECK(r4);
   }
   ...
   void conv_minus_assign_incoh_gt_inco()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure::dyn_per_cm2>( quan::pressure::atm(1999.),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure::kgf_per_cm2>( quan::pressure::kgf_per_m2(201.7867),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);
        
       bool r3
       = conv_minus_assign_impl<quan::pressure::ksi>( 
   ...
   void conv_minus_assign_incoh_gt_inco_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::dyn_per_cm2>( quan::pressure::atm(1999.),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kgf_per_cm2>( quan::pressure::kgf_per_m2(201.7867),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);
        
       bool r3
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::ksi>( 
           quan::pressure::lbf_per_ft2(1.676),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r3);
   ...
   void conv_minus_assign_incoh_less_inco()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure::atm>(  quan::pressure::dyn_per_cm2(1999.),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure::kgf_per_m2 >( quan::pressure::kgf_per_cm2(2.7867),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);
   ...
   void conv_minus_assign_incoh_less_inco_int()
   {
       bool r1 
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::atm>(  quan::pressure::dyn_per_cm2(1999.),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r1);
       
       bool r2
       = conv_minus_assign_impl<quan::pressure_<QUAN_INT32>::kgf_per_m2 >( quan::pressure::kgf_per_cm2(2.7867),FP_MAX_DIFFERENCE).first;
       QUAN_CHECK(r2);
