...
#define QUAN_TEST_FUN(fun) void fun ();
    ...
    QUAN_TEST_FUN(coh_coh_divide_test)
    QUAN_TEST_FUN(coh_incoh_divide_test)
    QUAN_TEST_FUN(incoh_coh_divide_test)
    QUAN_TEST_FUN(incoh_incoh_divide_test)
...
// coherent * coherent
   void coh_coh_divide_test()
   {
       quan::current::A  i(10);
       quan::voltage::V v(240);
       quan::resistance::R r = v / i;
       QUAN_CHECK_EQUAL(r.numeric_value(),
           (QUAN_FLOAT_TYPE(240) / QUAN_FLOAT_TYPE(10)));
    
       quan::current::uA i1(10);
       quan::voltage::mV v1(240);
       quan::resistance::kR r1 = v1 / i1;
       QUAN_CHECK_EQUAL(r.numeric_value(),
           (QUAN_FLOAT_TYPE(240) / QUAN_FLOAT_TYPE(10)));
      
   }
   // coherent * incoherent
   void coh_incoh_divide_test()
   {
       quan::time::ms T1(99.);
