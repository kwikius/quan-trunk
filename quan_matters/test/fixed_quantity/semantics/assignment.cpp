...
namespace {
   ...
   */
   ...
   std::pair<bool,To> conv_impl(From const & rhs, QUAN_FLOAT_TYPE eps = 0.)
   {
   ...
   // before comparison. conversion must use round-nearest algorithm.
...
//ok works now with larger rational
