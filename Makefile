...
.PHONY: fixed_quantity_semantics_test angle_test three_d_test two_d_test examples qdrt meta

all: fixed_quantity_semantics_test angle_test three_d_test two_d_test examples qdrt meta
